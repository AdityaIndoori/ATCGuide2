...
public class AT {
	...
	public String solutionWorking = "NA";//part2
	...
	public void setTrial1Action(String trial1Action) {
		this.trial1Action = trial1Action;
	}
	
	public void setTrial1Persons(String trial1Persons) {
		this.trial1Persons = trial1Persons;
	}
	...
	public String getTrial1CompletionDate() {
		return trial1CompletionDate;
	}
	...
	public String getSolutionWorking() {
		return solutionWorking;
	}
	
	public void setSolutionWorking(String solutionWorking) {
