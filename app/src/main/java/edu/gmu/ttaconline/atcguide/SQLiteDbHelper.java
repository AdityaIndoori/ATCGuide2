...
import edu.gmu.ttaconline.atcguide.SQLiteContract.TrialStore;
...
public class SQLiteDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_INTENT_ENTRIES = "CREATE TABLE "
            ...
            + IntentStore.COLUMN_NAME_ID_RECORD + " TEXT ,"
    ...
    public static final String SQL_CREATE_TRIAL = "CREATE TABLE "
            + TrialStore.TABLE_NAME +"("
            + TrialStore.COL_STUDENT_ID +" TEXT PRIMARY KEY,"
            + TrialStore.TRIAL_1 + " INTEGER DEFAULT 0,"
            + TrialStore.TRIAL_2 + " INTEGER DEFAULT 0)";
    ...
    private static final String SQL_DELETE_AT = "DROP TABLE IF EXISTS "
            + ATStore.TABLE_NAME;
    private static final String SQL_DELETE_TRIAL = "DROP TABLE IF EXISTS "
            + TrialStore.TABLE_NAME;
